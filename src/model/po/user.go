...
type User struct {
	Uid      uint64             `gorm:"type:bigint;       not null; primaryKey; autoIncrement"` // user id
	...
	Subscribings []*User  `gorm:"many2many:subscribe; foreignKey:Uid; references:Uid; joinForeignKey:from_uid; JoinReferences:to_uid"`   // tbl_subscribe
	Subscribers  []*User  `gorm:"many2many:subscribe; foreignKey:Uid; references:Uid; joinForeignKey:to_uid;   JoinReferences:from_uid"` // tbl_subscribe
	Favorites    []*Video `gorm:"many2many:favorite;  foreignKey:Uid; references:Vid; joinForeignKey:uid;      JoinReferences:vid"`      // tbl_favorite
