...
// @Model      VideoParam "视频请求参数"
// @Property   title       string true false "视频标题，长度在 [1, 100] 之间"
// @Property   description string true true  "视频简介，长度在 [0, 255] 之间"
// @Property   cover_url   string true false "视频封面链接"
