...
// // @return `*Playlist` `err`
// //
// // @exception `PlaylistNameUsedError` `PlaylistInsertError`
...
// // @return `*Playlist` `err`
// //
// // @exception `PlaylistNotFoundError` `AuthorizationError` `PlaylistNameUsedError` `PlaylistUpdateError`
//
...
// 	if old.Equals(after) {
// 		return after, PlaylistUpdateError
// 	} else {
// 		return after, nil
// 	}
// }
...
// // @return `*Playlist` `err`
// //
// // @exception `PlaylistNotFoundError` `AuthorizationError` `PlaylistDeleteError`
...
// 		return nil, PlaylistDeleteError
// 	} else {
// 		return query, nil
// 	}
// }
...
// // @return `*Playlist` `err`
// //
// // @exception `PlaylistNotFoundError` `AuthorizationError`
...
// // @return `*Playlist` `err`
// //
// // @exception `PlaylistNotFoundError` `AuthorizationError` `PlaylistVideoDeleteError`
...
// 		return nil, PlaylistVideoDeleteError
// 	} else {
// 		return query, nil
// 	}
// }
